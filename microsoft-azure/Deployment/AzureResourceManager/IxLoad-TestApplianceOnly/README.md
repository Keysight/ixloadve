...
Located in `microsoft-azure/Deployment/AzureResourceManager/IxLoad-TestApplianceOnly`, these ARM templates are organized into:
...
#### 🧪 Example #2: Deploying a Add On Use Case Template with one Virtual Test Appliances
